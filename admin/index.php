...
<body class="hold-transition login-page" style="background-color:#ecf1f9">
    <div class="login-box" style="background-color:#0e1f23 ;color:white ; font-size: 22px; font-family:Times">
        ...
        <div class="login-box-body"
            style="background-color:#a69f8b ;color:white ; font-size: 22px; font-family:Times  ">
