...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div style="background-color:#ecf1f9 ;color:black ; font-size: 17px; font-family:Times ">
      ...
      ?>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box" style="background-color: #f7fcfe">
                            <div class="box-header with-border" style="background-color: #f7fcfe">
                                <a href="#reset" data-toggle="modal" class="btn btn-danger btn-sm btn-curve"
                                    style="background-color: #ff8e88;color:black ; font-size: 12px; font-family:Times"><i
