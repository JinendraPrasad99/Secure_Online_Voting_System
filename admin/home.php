...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div style="background-color: #ecf1f9 ">
      ...
      ?>
                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6" style=" font-family:Times">
                        ...
                        <div class="small-box">
                            <div class="inner"
                                style="background-color:#f7fcfe ;color:black ; font-size:15px;  border-radius: 12px 12px 0px 0px;">
                                <?php
              ...
              ?>
                            ...
                            <a href="positions.php" class="small-box-footer "
                                style="background-color:#f1f1f1 ; color:black ; font-size:18px">More info <i
              ...
              ?>
                    ...
                    <div class="col-lg-3 col-xs-6" style=" font-family:Times">
                        ...
                        <div class="small-box ">
                            <div class="inner"
                                style="background-color: #f7fcfe ;color:black ; font-size:15px; font-family:Times;     border-radius: 12px 12px 0px 0px;">
                                <?php
                    ...
                    <div class="col-xs-12">
                        <h3> <b>VOTES TALLY
                                <span class="pull-right">
                                    ...
                                    <a href="print.php" class="btn btn-success btn-sm btn-curve"
                                        style="background-color: #2E8B57 ;color:black ; font-size: 12px; font-family:Times "><span
        ...
        while($row = $query->fetch_assoc()){
          ...
          echo "
           ...
           <div class='col-sm-6'  > 
              <div class='box box-solid' style='background-color: #f7fcfe' >
                <div class='box-header with-border' style='background-color: #f7fcfe'>
                  <h4 class='box-title'><b>".$row['description']."</b></h4>
                </div>
                <div class='box-body' style='background-color: #f7fcfe'>
                  <div class='chart' style='background-color: #f7fcfe'>
