...
<div class="modal fade" id="platform">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f7fcfe ;color:black ; font-size: 15px; font-family:Times ">
        ...
        <div class="modal-content" style="background-color: #f7fcfe ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-curve pull-left"
                    style='background-color:  #FFDEAD  ;color:black ; font-size: 12px; font-family:Times'
                    data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                <button type="submit" class="btn btn-success btn-curve"
                    style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times' name="edit"><i
        ...
        <div class="modal-content" style="background-color: #f7fcfe ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-curve pull-left"
                    style='background-color:  #FFDEAD  ;color:black ; font-size: 12px; font-family:Times'
                    data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                <button type="submit" class="btn btn-danger btn-curve"
                    style='background-color: #ff8e88 ;color:black ; font-size: 12px; font-family:Times' name="delete"><i
        ...
        <div class="modal-content" style="background-color: #f7fcfe ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-curve pull-left"
                    ...
                    data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                <button type="submit" class="btn btn-success btn-curve"
                    style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times' name="upload"><i
                        class="fa fa-check-square-o"></i> Update</button>
                </form>
            </div>
        </div>
